    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light ms-2">Open Account</a>
            <?php endif; ?>
        </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="hero-buttons">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary btn-lg me-3">Go to Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-3">Open Account</a>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-lg">Learn More</a>
                        <?php endif; ?>
                    </div>
