...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="nav-link me-3">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Open Account</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-3">Open Account</a>
            ...
            <div class="slide">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-3">Get Started</a>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg">Learn More</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-center">
            ...
            <div class="slide">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-3">Start Banking Globally</a>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg">Consult Expert</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-center">
    ...
    <section class="cta-section">
        <div class="container text-center">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg me-3">Get Started</a>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg">Sign In</a>
            <?php endif; ?>
        </div>
    </section>
...
</html><?php /**PATH /home2/molpsgco/public_html/oarkard/resources/views/welcome.blade.php ENDPATH**/ ?>