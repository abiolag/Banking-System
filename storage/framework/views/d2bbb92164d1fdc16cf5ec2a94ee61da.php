...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Oarkard - Modern Banking'); ?></title>
        ...
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a class="nav-link" href="<?php echo e(route('transfer.create')); ?>">Transfer</a>
                    <a class="nav-link" href="<?php echo e(route('transactions')); ?>">Transactions</a>
                ...
                <?php else: ?>
                    ...
                    <a class="btn btn-primary" href="<?php echo e(route('register')); ?>">Open Account</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
...
</html><?php /**PATH /home2/molpsgco/public_html/oarkard/resources/views/layouts/app.blade.php ENDPATH**/ ?>